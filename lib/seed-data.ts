...
const connections: Connection[] = [
  { id: 'conn-1', fromId: 'obj-stoic-morning', toId: 'obj-dichotomy', label: 'builds on' },
  { id: 'conn-2', fromId: 'obj-dichotomy', toId: 'obj-enchiridion-link', label: 'source' },
  { id: 'conn-3', fromId: 'obj-amor-fati', toId: 'obj-dichotomy', label: 'contrasts with' },
  { id: 'conn-4', fromId: 'obj-ferment-log', toId: 'obj-ph-meter', label: 'uses method' },
  { id: 'conn-5', fromId: 'obj-ferment-log', toId: 'obj-noma-link', label: 'reference' },
  { id: 'conn-6', fromId: 'obj-sourdough-idea', toId: 'obj-ferment-log', label: 'related craft' },
  { id: 'conn-7', fromId: 'obj-swiss-grid', toId: 'obj-color-oxblood', label: 'same system' },
  { id: 'conn-8', fromId: 'obj-spatial-memory', toId: 'obj-stoic-morning', label: 'method of loci' },
  { id: 'conn-9', fromId: 'obj-garden-note', toId: 'obj-spatial-memory', label: 'informs' },
  { id: 'conn-10', fromId: 'obj-lisbon-plan', toId: 'obj-tram-link', label: 'logistics' },
  { id: 'conn-11', fromId: 'obj-walk-idea', toId: 'obj-getting-things-done', label: 'tension with' },
];
